/**
 * client/src/pages/UpcomingList.tsx
...
function nextBirthdayMonth(friend: Friend): number | null {
...
export default function UpcomingList() {
  ...
  const groups = sorted.reduce<Record<number, Friend[]>>((acc, friend) => {
  ...
  return (
    <div className={styles.page}>
      ...
      {isError && (
        <div className={styles.error}>⚠️ Failed to load: {(error as Error).message}</div>
      )}
                ...
                >
                  ...
                  <div className={styles.info}>
                    ...
                    <span className={styles.detail}>
                      {birthdayStr} · Turns {(friend.age ?? 0) + 1}
                    </span>
                  </div>
